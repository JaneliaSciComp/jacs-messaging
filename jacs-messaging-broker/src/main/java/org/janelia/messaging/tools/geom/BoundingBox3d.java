package org.janelia.messaging.tools.geom;

import org.janelia.messaging.tools.units.BaseDimension;
import org.janelia.messaging.tools.units.PhysicalUnit;
import org.janelia.messaging.tools.units.SI;
...
public class BoundingBox3d {
	...
	protected PhysicalUnit<BaseDimension.Length> physicalUnit = SI.micrometer;

	public BoundingBox3d() {
	}
	
	public BoundingBox3d(Vec3 min, Vec3 max) {
	    this.min = min;
	    this.max = max;
	}
